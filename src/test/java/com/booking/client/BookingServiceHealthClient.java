...
import com.booking.stepdefinitions.BookingServiceHealthSteps;
import com.booking.utils.logging.LoggerUtil;
import io.restassured.response.Response;
import org.apache.logging.log4j.Logger;
import static io.restassured.RestAssured.given;

public class BookingServiceHealthClient {
    private static final Logger logger = LoggerUtil.getLogger(BookingServiceHealthSteps.class);

    private BookingServiceHealthClient() {
    ...
    public static Response getHealthStatus() {
        ...
        Response response = given()
                ...
                .when()
                .get(endpoint);
        logger.info("Health Check response body: {}", response.asString());
        return response;
    }
}